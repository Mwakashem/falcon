              ...
              <ul class="navbar-nav flex-column">
                <li class="nav-item"><a class="nav-link dropdown-indicator" href="#home" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="home">
                  ...
                  <ul class="nav collapse show" id="home" data-parent="#navbarVerticalCollapse">
                    <li class="nav-item"><a class="nav-link" href="/repayments">Loan Listings</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="/repayments/add">Add New repayments</a>
                    </li>
                  </ul>
                </li>
            ...
            <div class="col-sm-6 col-md-4">
              <div class="card overflow-hidden" style="min-width: 12rem">
                ...
                <div class="card-body position-relative">
                  <h6>repayments<span class="badge badge-soft-warning rounded-pill ml-2">-</span></h6>
                  <div class="display-4 fs-4 mb-2 fw-normal font-sans-serif text-warning" data-countup='{"endValue":{{$repayments->count() }},"suffix":" repayments"}'>0</div><a class="fw-semi-bold fs--1 text-nowrap" href="e-commerce/customers.html">See all<span class="fas fa-angle-right ml-1" data-fa-transform="down-1"></span></a>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-4">
              <div class="card overflow-hidden" style="min-width: 12rem">
                ...
                <div class="card-body position-relative">
                  <h6>Banks<span class="badge badge-soft-info rounded-pill ml-2"></span></h6>
                  <div class="display-4 fs-4 mb-2 fw-normal font-sans-serif text-info" data-countup='{"endValue":{{$repayments->groupBy('bankName')->count() }},"suffix":" Banks"}'>0</div><a class="fw-semi-bold fs--1 text-nowrap" href="e-commerce/orders.html">All Banks<span class="fas fa-angle-right ml-1" data-fa-transform="down-1"></span></a>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card mb-3 overflow-hidden" style="min-width: 12rem">
                ...
                <div class="card-body position-relative">
                  ...
                  <div class="display-4 fs-4 mb-2 fw-normal font-sans-serif" data-countup='{"endValue":{{$repayments->SUM('loanAmount')}},"prefix":"Ksh."}'>0</div><a class="fw-semi-bold fs--1 text-nowrap" href="/">Statistics<span class="fas fa-angle-right ml-1" data-fa-transform="down-1"></span></a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="row flex-between-center">
                ...
                <div class="col-6 col-sm-auto ml-auto text-right pl-0">
                  ...
                  <div id="table-purchases-replace-element">
                    <button class="btn btn-falcon-default btn-sm" type="button"><span class="fas fa-plus" data-fa-transform="shrink-3 down-2"></span><span class="d-none d-sm-inline-block ml-1"><a href="/repayments/add"> New Loan</a></span></button>
                ...
                <table class="table table-sm fs--1 mb-0">
                  <thead class="bg-200 text-900">
                    <tr>
                      ...
                      <th class="sort pr-1 align-middle white-space-nowrap" data-sort="email">Amount Due</th>
                  ...
                  <tbody class="list" id="table-purchase-body">
                    <tr class="btn-reveal-trigger">
                      ...
                      {{-- $repayments->orderBy('id', 'DESC')->first()->principal --}}
                      {{-- <th class="align-middle white-space-nowrap name"><a href="pages/customer-details.html">{{$repayments->loans()->}}</a></th> --}}
                      <td class="align-middle white-space-nowrap email">Ksh.{{number_format($repayments->scheduledPayment)}}</td>
                      {{-- <td class="align-middle white-space-nowrap email">{{$repayments->orderBy('id', 'ASC')->first()->start_date}}</td> --}}
                      <td class="align-middle white-space-nowrap email">{{$repayments->orderBy('start_date', 'ASC')->start_date}}</td>
                      <td class="align-middle white-space-nowrap email">Ksh.{{number_format($repayments->orderBy('id', 'ASC')->first()->principal)}}</td>
                      <td class="align-middle white-space-nowrap product">{{$repayments->interestRate}}%</td>
                      <td class="align-middle text-center fs-0 white-space-nowrap payment"><span class="badge badge rounded-pill badge-soft-success">{{$repayments->startDate}}<span class="ml-1 fas fa-check" data-fa-transform="shrink-2"></span></span>
                      </td>
                      <td class="align-middle text-right amount">{{ $repayments->orderBy('id', 'ASC')->first()->start_date}}</td>
                      <td class="align-middle white-space-nowrap">
                        <div class="dropdown font-sans-serif">
                          ...
                          <div class="dropdown-menu dropdown-menu-right border py-2" aria-labelledby="dropdown0"><a class="dropdown-item" href="/repayments/{{$repayments->id}}">View</a>
                          </div>
                        </div>
                      </td>
                    </tr>
