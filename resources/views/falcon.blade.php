            ...
            <div class="col-sm-6 col-md-4">
              <div class="card overflow-hidden" style="min-width: 12rem">
                ...
                <div class="card-body position-relative">
                  <h6>loans<span class="badge badge-soft-warning rounded-pill ml-2">-</span></h6>
                  <div class="display-4 fs-4 mb-2 fw-normal font-sans-serif text-warning" data-countup='{"endValue":{{$loans->count() }},"suffix":" Loans"}'>0</div><a class="fw-semi-bold fs--1 text-nowrap" href="e-commerce/customers.html">See all<span class="fas fa-angle-right ml-1" data-fa-transform="down-1"></span></a>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-4">
              <div class="card overflow-hidden" style="min-width: 12rem">
                ...
                <div class="card-body position-relative">
                  ...
                  <div class="display-4 fs-4 mb-2 fw-normal font-sans-serif text-info" data-countup='{"endValue":{{$loans->groupBy('bankName')->count() }},"suffix":" Banks"}'>0</div><a class="fw-semi-bold fs--1 text-nowrap" href="e-commerce/orders.html">All Banks<span class="fas fa-angle-right ml-1" data-fa-transform="down-1"></span></a>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              ...
              <div class="row flex-between-center">
                ...
                <div class="col-6 col-sm-auto ml-auto text-right pl-0">
                  ...
                  <div id="table-purchases-replace-element">
                    <button class="btn btn-falcon-default btn-sm" type="button"><span class="fas fa-plus" data-fa-transform="shrink-3 down-2"></span><span class="d-none d-sm-inline-block ml-1"><a href="/loans/add"> New Loan</a></span></button>
